...
public:
	UToonShaderBootstrapSettings()
		: bRestoreDefaultShaderDirectory(false)
	...
	// 建议修改shader调试时才打开
	UPROPERTY(EditAnywhere, Config, Category = "启动设置", meta = (DisplayName = "总是替换ToonShader文件夹", EditCondition = "bRestoreDefaultShaderDirectory == false"))
